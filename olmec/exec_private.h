...
_(L9, NOUN,     ASSN,     NOUN,     ANY,      move,     3,    1,     0) \
...
_(L16,LBRAC,    LBRAC,    RBRAC,    ANY,      bracidx,  3,    1,     0) \
_(L17,VRB+ADV,  LBRAC,    RBRAC,    ANY,      funcidx,  3,    1,     0) \
_(L18,NOUN,     LBRAC,    RBRAC,    ANY,      nounidx,  3,    1,     0) \
/**/
